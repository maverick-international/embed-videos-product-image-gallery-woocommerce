    ...
    jQuery(".woocommerce-product-gallery").each(function () {
        jQuery(this)
            ...
            .each(function () {
                jQuery(this).attr(
                    "data-size",
                    jQuery(this).find("iframe").attr("width") +
                        "x" +
                        jQuery(this).find("iframe").attr("height")
                )
            })
    })
}, 3000)
var initPhotoSwipeFromDOM = function (gallerySelector) {
    ...
    var parseThumbnailElements = function (el) {
        var thumbElements = jQuery(el)
                .find(
                    ".woocommerce-product-gallery__image:not(.isotope-hidden)"
                )
                .get(),
    ...
    var openPhotoSwipe = function (
        ...
        gallery.listen("beforeChange", function () {
            ...
            jQuery(".pswp__caption .pswp__caption__center").removeClass(
                "active"
            )
